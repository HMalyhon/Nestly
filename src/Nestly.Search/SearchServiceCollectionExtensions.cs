...
public static class SearchServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddNestlySearch(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Singleton because the ONNX session holds the 90 MB of weights and is safe to call
        // concurrently; building one per request would be the whole cost of the feature, twice.
        services.AddSingleton<IListingEmbedder, OnnxListingEmbedder>();
